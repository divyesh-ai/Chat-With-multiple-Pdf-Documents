...
def get_conversational_chain():
    prompt_template = """
    Answer the questions as detailed as possible from the provided context, make sure to provide all the deatils, if the answer is not in
    provided ccontext just say, "answer is not available in the context", dont provide the wrong answer\n\n
    context:\n {context}?\n
    Question: \n{question}\n
